...
const ES: Record<string, string> = {
  ...
  "A photo is required.": "Se requiere una foto.",
  ...
  'Nothing here is a test, and there\'s no wrong way to answer any of it. This helps me know you more fully — your body, your history, your life — beyond what we\'ve already covered together. Take your time, answer as honestly as you can, and don\'t worry about getting it "right." Update it any time something changes.':
    'Nada de esto es una prueba, y no hay una forma incorrecta de responder. Esto me ayuda a conocerte más plenamente — tu cuerpo, tu historia, tu vida — más allá de lo que ya hemos hablado juntas. Tómate tu tiempo, responde con la mayor honestidad posible, y no te preocupes por hacerlo "correctamente." Actualízalo cuando algo cambie.',
  You: "Tú",
  "What brought you to MeFirstFitness": "Qué te trajo a MeFirstFitness",
  "What would make this feel worthwhile a year from now": "Qué haría que esto valiera la pena dentro de un año",
  "Your body right now": "Tu cuerpo en este momento",
  "How would you describe your current fitness level?": "¿Cómo describirías tu nivel de condición física actual?",
  "Complete beginner": "Principiante total",
  "Some experience": "Algo de experiencia",
  "Moderately active": "Moderadamente activa/o",
  "Previously very active": "Muy activa/o anteriormente",
  "Athlete / competitive": "Atleta / competitiva/o",
  "Current satisfaction with how your body feels (1 = very dissatisfied, 10 = completely at ease)":
    "Satisfacción actual con cómo se siente tu cuerpo (1 = muy insatisfecha/o, 10 = completamente cómoda/o)",
  "Areas of your body that feel strong or capable": "Áreas de tu cuerpo que sientes fuertes o capaces",
  "Any injuries, surgeries, or physical limitations Mickey should know about":
    "Cualquier lesión, cirugía, o limitación física que Mickey debería saber",
  "Balance & falls": "Equilibrio y caídas",
  "A fall in the past year": "Una caída en el último año",
  "A near-fall / stumble": "Un casi-caída / tropiezo",
  "Some fear of falling": "Algo de miedo a caerse",
  "If you checked one of those, tell me a little about what happened": "Si marcaste alguna de esas, cuéntame un poco qué pasó",
  "Bones, joints & chronic conditions": "Huesos, articulaciones y condiciones crónicas",
  "Osteoporosis/osteopenia": "Osteoporosis/osteopenia",
  "A joint replacement": "Un reemplazo articular",
  Arthritis: "Artritis",
  Hypermobility: "Hipermovilidad",
  "POTS/dysautonomia": "POTS/disautonomía",
  "Autoimmune condition": "Condición autoinmune",
  "Anything you'd add — which condition or joint, and how it is now": "Algo que quieras añadir — qué condición o articulación, y cómo está ahora",
  "General health history": "Historial general de salud",
  "Check all that apply:": "Marca todo lo que aplique:",
  "Heart condition": "Condición cardíaca",
  "High blood pressure": "Presión arterial alta",
  Diabetes: "Diabetes",
  Asthma: "Asma",
  "Thyroid condition": "Condición de tiroides",
  "Joint issues": "Problemas articulares",
  "Anxiety / depression": "Ansiedad / depresión",
  "Eating disorder history": "Historial de trastorno alimenticio",
  "Pregnancy / postpartum": "Embarazo / posparto",
  "Medications & your doctor": "Medicamentos y tu médico",
  "Medications worth knowing about (blood pressure, blood thinners, etc.)":
    "Medicamentos que valga la pena mencionar (presión arterial, anticoagulantes, etc.)",
  "Your doctor's name, if you'd like me to be able to reach them": "El nombre de tu médico, si te gustaría que pudiera contactarlo",
  "Medical clearance to train": "Autorización médica para entrenar",
  "I've already gotten clearance to train": "Ya obtuve autorización para entrenar",
  "I'm still working on that": "Todavía estoy en eso",
  "I haven't needed to": "No lo he necesitado",
  "Day to day": "Día a día",
  "I live alone": "Vivo sola/o",
  "I still drive myself everywhere": "Todavía manejo sola/o a todas partes",
  "Stairs are part of my daily life": "Las escaleras son parte de mi vida diaria",
  "Anything that feels harder these days than it used to": "Algo que se sienta más difícil ahora que antes",
  "Where pain lives right now": "Dónde vive el dolor en este momento",
  "My goal from day one is training around pain, never through it. Pain is information for me, not something for you to push through.":
    "Mi objetivo desde el primer día es entrenar alrededor del dolor, nunca a través de él. El dolor es información para mí, no algo que debas superar a la fuerza.",
  "Where you feel pain right now, in your own words": "Dónde sientes dolor en este momento, en tus propias palabras",
  "How long this has been going on": "Cuánto tiempo lleva pasando esto",
  "What tends to make it better": "Qué tiende a mejorarlo",
  "What tends to make it worse": "Qué tiende a empeorarlo",
  "What kind of pain, if any": "Qué tipo de dolor, si acaso",
  Sharp: "Agudo",
  "Dull/achy": "Sordo/adolorido",
  Burning: "Ardiente",
  "Tingling/numb": "Hormigueo/entumecido",
  Stiff: "Rígido",
  "Right now, on a scale of 1–10": "En este momento, en una escala del 1 al 10",
  "In your own words, what do you most want to change or feel differently about?":
    "En tus propias palabras, ¿qué es lo que más quieres cambiar o sentir diferente?",
  "What does success look like to you 3 months from now?": "¿Cómo se ve el éxito para ti dentro de 3 meses?",
  "What has held you back from reaching your goals before?": "¿Qué te ha detenido de alcanzar tus metas antes?",
  "Goal importance (1 = not very important, 10 = top priority)": "Importancia de la meta (1 = no muy importante, 10 = máxima prioridad)",
  "Confidence to change (1 = not confident, 10 = fully ready)": "Confianza para cambiar (1 = nada confiada/o, 10 = completamente lista/o)",
  "Your relationship with food right now": "Tu relación con la comida en este momento",
  "Comfortable": "Cómoda/o",
  Complicated: "Complicada",
  "Actively working on it": "Trabajando activamente en ello",
  "Rather not say": "Prefiero no decir",
  "Anything about food you'd want me to know": "Algo sobre la comida que quisieras que supiera",
  "Foods you love that you'd never want to give up": "Comidas que amas y nunca querrías dejar",
  "Foods that feel scary, forbidden, or guilt-inducing": "Comidas que se sienten aterradoras, prohibidas, o que provocan culpa",
  "Have you ever been on a structured diet or weight loss program?": "¿Alguna vez has seguido una dieta estructurada o un programa de pérdida de peso?",
  Never: "Nunca",
  "Once or twice": "Una o dos veces",
  "Many times": "Muchas veces",
  "Currently on one": "Actualmente en una",
  "How much does food stress affect your daily mood? (1 = not at all, 10 = significantly every day)":
    "¿Cuánto afecta el estrés por la comida tu estado de ánimo diario? (1 = nada, 10 = significativamente todos los días)",
  Lifestyle: "Estilo de vida",
  "Who or what supports you on this journey": "Quién o qué te apoya en este camino",
  "What's the biggest competing demand on your time": "Cuál es la mayor demanda que compite por tu tiempo",
  "Average sleep per night": "Promedio de sueño por noche",
  "How long have you slept this way?": "¿Cuánto tiempo has dormido así?",
  "Main sources of stress in your life right now": "Principales fuentes de estrés en tu vida en este momento",
  "How do you typically cope with stress?": "¿Cómo sueles manejar el estrés?",
  "How you like to be coached": "Cómo te gusta que te entrenen",
  "How do you like to be coached during a session?": "¿Cómo te gusta que te entrenen durante una sesión?",
  "Lots of encouragement": "Mucho ánimo",
  "Push me / challenge me": "Empújame / retame",
  "Quiet and focused": "Tranquila y enfocada",
  "Flexible — read my mood": "Flexible — lee mi estado de ánimo",
  "How do you prefer feedback in the moment?": "¿Cómo prefieres recibir retroalimentación en el momento?",
  "Direct and honest": "Directa y honesta",
  "Mix of both": "Una mezcla de ambas",
  "Gentle and encouraging": "Suave y alentadora",
  "Mostly positive, correct only big issues": "Mayormente positiva, corrige solo los problemas grandes",
  "Best way to reach you between sessions?": "¿Cuál es la mejor forma de contactarte entre sesiones?",
  Call: "Llamada",
  "I'll reach out if needed": "Yo te contactaré si es necesario",
  "How often would you like check-ins between sessions?": "¿Con qué frecuencia te gustaría tener check-ins entre sesiones?",
  Weekly: "Semanalmente",
  "Every session only": "Solo en cada sesión",
  "Only if I reach out": "Solo si yo te contacto",
  "Not at all, just session time": "Nada, solo el tiempo de sesión",
  "What kind of accountability helps you most?": "¿Qué tipo de responsabilidad/seguimiento te ayuda más?",
  "Regular check-ins from Mickey": "Check-ins regulares de Mickey",
  "Tracking my own progress": "Dar seguimiento a mi propio progreso",
  "Scheduled sessions are enough": "Las sesiones programadas son suficientes",
  "Friendly reminders / nudges": "Recordatorios amistosos",
  "Anything that has NOT worked for you with past coaches or trainers": "Algo que NO te haya funcionado con entrenadores anteriores",
  "Is there anything else you'd like Mickey to know?": "¿Hay algo más que te gustaría que Mickey supiera?",
  "How did you hear about MeFirstFitness?": "¿Cómo te enteraste de MeFirstFitness?",
