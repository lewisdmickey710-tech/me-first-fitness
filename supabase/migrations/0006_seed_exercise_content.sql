...
update public.exercises set
  client_description = 'Lie on your back with knees bent, feet flat on the floor about hip-width apart. Lift one foot off the ground — knee bent toward your chest or leg extended, whichever your coach has you doing — and plant firmly through the other heel. Brace your core, then drive through that planted heel to lift your hips until your body forms a straight line from shoulder to knee. Keep both hips level the whole way up — don''t let the lifted-leg side sag or rotate open. Squeeze your glute at the top for a beat, then lower with control before the next rep.',
  coach_cues = 'Hip drop or rotation on the non-working side is the #1 compensation — watch the far hip, not the working leg. Cue: "keep your hip bones level," or a light hand tap on the hip that''s sagging.
...
Progression trigger: a full clean set on both sides with level hips before adding a pause or light load.'
...
update public.exercises set
  ...
  coach_cues = 'Knees track over — not past — the toes; watch for valgus (knees caving in) and cue "push the floor apart."
...
Progression trigger: controlled full-depth reps with stable knees on the Bosu before adding weight.'
...
update public.exercises set
  ...
  coach_cues = 'Hips must stay square — watch for the back leg''s hip rotating open ("kickstand" cue: point that hip at the floor, not the wall).
...
Progression trigger: controlled full-range reps with square hips and no wobble before adding load in the reaching hand.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for the trailing foot dragging all the way in, which lets the band go slack and kills tension — cue "never let the band rest."
...
Progression trigger: full set both directions with consistent band tension and no knee cave before moving the band higher or upsizing it.'
...
update public.exercises set
  ...
  coach_cues = 'Watch the ankle for rolling inward (pronation) as fatigue sets in — cue "straight up and down through the big toe and pinky toe evenly."
...
Progression trigger: full-range reps to the target count with a stable ankle before removing the support hand or adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Bird Dog: the #1 fault is hip rotation as the leg extends — cue "hips square to the floor," and regress range of motion before adding speed.
...
Keep the neck long and gaze down/neutral in both drills, not craning forward.'
...
update public.exercises set
  ...
  coach_cues = 'Push-up: watch for hips sagging or piking — the leg lift only adds value if the trunk stays rigid; regress to an incline or knees if the line breaks down.
...
Progression trigger: clean push-up form with a controlled leg lift before decreasing the incline, or moving to full dumbbell bench.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for lumbar arching as the weight goes overhead — the rib cage should stay stacked over the hips, not flare up.
...
Progression trigger: full set with square hips and a straight overhead path before increasing load.'
...
update public.exercises set
  ...
  coach_cues = 'Upper arm must stay glued to the ribs — if the elbow drifts forward on the push down, shoulder muscles are sneaking in to help the triceps.
...
Progression trigger: clean form both sides before increasing band tension.'
...
update public.exercises set
  ...
  coach_cues = 'Elbow bend should stay constant through the whole range — if it straightens at the start and bends at the end, the tricep is sneaking in instead of the chest doing the work.
...
Progression trigger: smooth, controlled arc with a stable base before adding weight.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for shrugging the shoulders toward the ears as the arms rise — cue "long neck, shoulders down" and lighten the load if this shows up early.
...
Progression trigger: full set with stable shoulders and stance before increasing load.'
...
update public.exercises set
  ...
  coach_cues = 'The low back must stay pressed into the floor in both drills — if it arches as the limbs move, that''s the range limit for this client right now; shorten the range rather than letting the back take over.
...
Progression trigger: full range with a flat low back before extending further or adding a hold.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for the torso rotating toward the pulling arm — the row should come from the shoulder blade, not a twist through the spine.
...
Progression trigger: stable stance and clean shoulder-blade movement before increasing band tension.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for leaning back excessively to "cheat" the weight down — a slight lean is fine, but the torso shouldn''t be doing the work the lats should be doing.
...
Progression trigger: full controlled range with good shoulder positioning before reducing band assistance.'
...
update public.exercises set
  ...
  coach_cues = 'Elbow stays fixed at the side — any forward or backward drift means momentum or shoulder muscles are helping instead of the bicep working alone.
...
Progression trigger: strict form both sides before increasing load.'
...
update public.exercises set
  ...
  coach_cues = 'Elbows should finish high, at or above shoulder height, not drifting into a low row — that''s what separates a face pull from a regular row.
...
Progression trigger: clean elbow-high finish both sides before increasing band tension.'
where name = 'Single-Leg Face Pull' and client_description is null;

update public.exercises set
  client_description = 'Sit on the ground with your upper back against a bench or bed, one foot planted flat on the floor, and extend the other leg straight out in front of you or hold it lifted. Brace your core and drive through the planted heel to lift your hips until your body forms a straight line from shoulder to knee, keeping your hips square — don''t let the working side twist or the non-working side dip. Squeeze at the top, then lower with control.',
  coach_cues = 'This is the single-leg progression of the barbell version — same faults apply, amplified: watch closely for lumbar hyperextension (ribs flaring) at the top since there''s no bar to anchor the tempo.
...
Progression trigger: clean bilateral-feeling reps (no rotation, no lumbar compensation) before adding a light band or extra range.'
...
update public.exercises set
  ...
  coach_cues = 'The breathing drill is about ribcage control, not lung volume — watch for the classic fault of the ribs flaring and the low back arching on the inhale; if that happens, the exhale wasn''t complete.
...
Often used as a calming, nervous-system-down-regulating start or finish to a session — the pace should reflect that.'
...
update public.exercises set
  ...
  coach_cues = 'Knees must track over toes throughout — the wide stance makes valgus (knees caving in) an easy fault to miss if you''re not watching closely.
...
Progression trigger: full-depth reps with stable knee tracking before adding load.'
where name = 'Sumo Squat' and client_description is null;

update public.exercises set
  client_description = 'Stand on the flat or dome side of a Bosu ball (per your coach''s setup), feet shoulder-width apart. Perform a standard squat — hips back and down, chest up, weight through the whole foot — while managing the extra balance demand of the unstable surface. Move slower than you would on flat ground and don''t rush the reps.',
  coach_cues = 'The instability should challenge balance and stabilizer muscles, not cause the knees to cave or the squat depth to shrink dramatically compared to flat ground — regress to flat ground if either happens.
...
Progression trigger: stable, full-depth reps on the Bosu before increasing load or moving to a single-leg variation.'
...
update public.exercises set
  ...
  coach_cues = 'Watch the elbow angle — flared to 90 degrees stresses the shoulder, tucked too tight overloads the triceps; 45 degrees is the target for most clients.
...
Progression trigger: consistent bar path and stable shoulder position before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Hips must stay lifted and level throughout the set — this is really a bridge and a chest press happening at once, and the hips dropping is the first sign of fatigue.
...
Progression trigger: stable hips and clean press mechanics together before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'This is a hip-hinge, not a squat — watch for the knees bending too much and turning it into a sumo squat instead of a hinge.
...
Progression trigger: full controlled range with a flat back before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for the torso rising up toward vertical as the client fatigues — the hip-hinge angle should stay consistent set to set.
...
Progression trigger: consistent torso angle and clean elbow path before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Hips must stay square to the floor, same fault pattern as the single-leg RDL — watch the back leg''s hip for rotating open.
...
Progression trigger: stable hips and clean pull before increasing load.'
...
update public.exercises set
  ...
  coach_cues = 'Back must stay flat/neutral from setup through lockout — this is the highest-stakes compensation to catch early; if it rounds, the weight is too heavy or the hip-hinge pattern needs more practice at lighter load first.
...
Progression trigger: clean bar path and neutral spine at working weight before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Same core fault as the hip thrust family: watch for lumbar hyperextension (ribs flaring, back arching) at the top instead of a controlled glute squeeze — cue "ribs to hips."
...
Progression trigger: two clean sessions with full lockout and no lumbar compensation before adding load, same standard as the full hip thrust.'
...
update public.exercises set
  ...
  coach_cues = 'Watch the bench angle — too steep turns this into a shoulder press and shifts the target away from the upper chest; 30-45 degrees is the target range.
...
Progression trigger: consistent press path and stable shoulder position before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Most of the load should be through the front leg — the back foot on the bench is for balance, not to push off.
...
Progression trigger: controlled depth and stable knee tracking on both sides before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Watch the bent knee for tracking over the toes, not caving inward, especially as the client fatigues.
...
Progression trigger: full range with stable knee tracking on both sides before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Elbows should finish high, at or above shoulder height — a low finish turns this into a regular row and misses the rear-delt/upper-back target.
...
Progression trigger: clean elbow-high finish before increasing resistance.'
...
update public.exercises set
  ...
  coach_cues = 'Watch closely for hips sagging or piking, more likely here given the added load from the elevated-feet position — regress the foot height if the line breaks down.
Elbow angle stays moderate, same as bench press cueing.
Full range: chest gets close to the floor, full lockout at the top.
Progression trigger: clean full-range reps at a given foot height before raising it further.'
...
update public.exercises set
  ...
  coach_cues = 'All the standard hip thrust cues apply, and matter more at heavier loads: watch closely for lumbar hyperextension as the first sign the weight has outpaced control.
...
Bar should be well-padded and positioned consistently across the hip crease each rep.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for the low back arching to generate extra range — the movement should come from the hip extending, not the spine.
...
Progression trigger: controlled full range both directions before increasing resistance.'
...
update public.exercises set
  ...
  coach_cues = 'At heavier loads, watch closely for the torso pitching forward and the heels lifting — both are signs the weight has exceeded current mobility or strength at this depth.
...
Progression trigger: stable depth and torso position at the current load for two clean sessions before adding more weight.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for pushing off the bottom (trailing) foot to help — the goal is for the top leg to do the work; lighten the load if the client is clearly leaning on the back foot.
...
Progression trigger: controlled step-up and step-down with no push-off assistance before adding load or box height.'
...
update public.exercises set
  ...
  coach_cues = 'Elbows lead the pull, driving down and back — don''t let this turn into an arm curl.
...
Progression trigger: clean full-range reps before adding load or reducing assistance.'
...
update public.exercises set
  ...
  coach_cues = 'Back stays flat the entire range — if it rounds, that''s the depth limit for this client today, not a range to push through.
...
update public.exercises set
  ...
  coach_cues = 'Front knee tracks over the foot, not caving inward as the leg crosses behind.
...
Progression trigger: controlled full range on both sides with stable front-knee tracking before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Shoulder blades stay set back and down throughout — watch for them rolling forward as fatigue sets in, which shifts stress onto the front of the shoulder.
...
Progression trigger: consistent shoulder position and controlled tempo before adding load.'
...
update public.exercises set
  ...
  coach_cues = 'Watch for the torso leaning away from the working leg to help lift it higher — the movement should come from the hip, not a body lean creating fake range.
...
Progression trigger: controlled full range with a stable torso before increasing resistance.'
...
update public.exercises set
  ...
  coach_cues = 'The whole point is resisting lateral flexion — watch for the torso leaning toward the weight-free side to compensate; cue "stand as tall on this side as the other."
...
Progression trigger: full distance carried tall and level on both sides before increasing load.'
